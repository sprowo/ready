 ...
 */
public class ShadowClassLoader extends ClassLoader implements DynamicLoader {
    ...
    public InputStream getResourceAsStream(String path) {
        ...
        return resouceBytes != null ? new ByteArrayInputStream(resouceBytes) : super.getResourceAsStream(path);
    }
    ...
    private String getFileNameByClassName(String className) {
        ...
        String fileName = new StringBuilder().append(className.replaceAll("\\.", separator)).append(".class")
                .toString();
        return fileName;
    }
    ...
    private String getClassNameByFileName(String fileName) {
        ...
        String className = fileName.replaceAll("\\/", ".").replaceFirst("\\.class", "");
        return className;
    }
